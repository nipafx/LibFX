...
/**
 * A builder for all kinds of nested functionality whose innermost value is held by a {@link StringProperty}.
 */
public class StringPropertyNestingBuilder extends AbstractNestingBuilder<Number, StringProperty> {
