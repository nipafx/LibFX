 ...
 * instances. The same default value instance will be used to represent the empty {@code Optional}, so when elements
 * equal to it are added, they will be retrieved as that instance (thus loosing their identity).
 * <p>
